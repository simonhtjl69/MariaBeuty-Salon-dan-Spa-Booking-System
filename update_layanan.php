...
<html>
	...
	<body>
		...
		<?php 
			...
			$show = mysqli_query($conn, "SELECT * FROM layanan WHERE id_layanan='$id'");
				...
				<div class="row">
					<div class="col-md-12">
						<div class="product">
							...
							<h3>Edit Layanan</h3><hr class="pg-titl-bdr-bte"></hr>
							
							<form action="update_layanan_process.php?id_layanan=<?php echo $id ?>" method="post" enctype="multipart/form-data">
