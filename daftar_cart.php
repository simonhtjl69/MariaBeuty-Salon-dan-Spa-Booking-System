...
<html> 
  ...
  <body>
    ...
    <?php 
    include 'db.php';
    $data = mysqli_query($conn,"SELECT * FROM  detail_pembelian");
    while($d = mysqli_fetch_array($data)){
      ...
      <tr>
        ...
        <td>
          <a href="delete_pembelian.php?items_id=<?=$d['id_pembelian']?>"><button class="btn btn-danger"><i class="fa fa-trash"></i></button></a></td>
