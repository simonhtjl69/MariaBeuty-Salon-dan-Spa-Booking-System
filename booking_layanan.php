...
<html>
  ...
  <body>
    ...
    <?php
        ...
        $query = "SELECT * FROM layanan WHERE id_layanan = $idProdukDec";
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <form action="add_to_booking_process.php?add=1" method="post" role="form">
        <div class="form-group">
          <p>Tanggal :</p>
          <input type="text" class="input-tanggal form-control" name="tanggal" required>
          <p>Waktu Mulai :</p>
          <input type="text" class="input-waktu form-control" name="waktu" required>
          <p>Durasi(/Jam) :</p>
          <input type="number" min="1" max="<?=$items['stock']?>" name="jumlah" value="1" class="form-control" required />
        </div>
        <br>
        <div class="text-center"><button type="submit" class="btn btn-komentar btn-lg"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Booking</button></div>
